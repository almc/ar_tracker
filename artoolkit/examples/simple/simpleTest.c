...
#define nmarkers 4
char           *patt_name[nmarkers]      = {"Data/patt.hiro", "Data/patt.kanji", "Data/patt.sample1", "Data/patt.sample2"};
...
static void mainLoop(void)
{
    ...
    int verified_markers[marker_num];
    for (j = 0; j < marker_num; j++) {
	    verified_markers[j] = 0;
    }
